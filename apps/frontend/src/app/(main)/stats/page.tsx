...
export default function StatsPage() {
  ...
  if (loading) {
    return (
      <div className="mx-auto h-full max-w-6xl overflow-y-auto">
        <div className="space-y-6">
          <MogePageHeader title="统计" description="查看您的写作成果和进度" icon={BarChart} />
        ...
        <Card>
          ...
          <CardContent>
            {Object.keys(stats.dailyStats).length > 0 ? (
              ...
              <p className="text-muted-foreground py-8 text-center text-sm">最近7天暂无写作记录</p>
            )}
          </CardContent>
        </Card>
